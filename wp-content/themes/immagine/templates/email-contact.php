...
<head>
  ...
  <title>Immagine Salón & Spa</title>
  <style type="text/css">
...
<body yahoo bgcolor="#fe4431" style="margin: 0; padding: 0; min-width: 100% !important;">
<table width="100%" bgcolor="#fe4431" border="0" cellpadding="0" cellspacing="0">
<tr>
  <td>
    <!--[if (gte mso 9)|(IE)]>
    ...
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0" style="width: 100%; max-width: 600px; background-color: #ffffff;">
      <tr>
        <td bgcolor="#fe4431" class="header" style="padding: 40px 30px 20px 30px;">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="112" align="center">
                <img class="fix" src="<?php echo get_template_directory_uri(); ?>/images/logo.png" border="0" alt="Immagine Salón & Spa" />
              </td>
            </tr>
          </table>
        </td>
                    ...
                    <tr>
                      <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td class="bodycopy" style="padding: 10px 10px 10px 10px; font-size: 14px; line-height: 18px; color: #484848; font-family: Arial;"><?php echo $dataService->name; ?></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
